...
describe Curator::Middleware::CuratorFinder do
  before :each do
    ...
    ::Curator::Curator.stub!(:new).and_return(@curator)
  end
  ...
  it "should call Curator::Curator.new with event machine and instance ID" do
    ::Curator::Curator.should_receive(:new).with(@id, @em).and_return(@curator)
    @it.call(@env)
  end
